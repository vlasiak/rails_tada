...
Item.create(text: %{Hover over me and click the button to my right to assign a due date >}, list_id: second_list.id, done: true)

Item.create(text: %{Click the name of this to-do list to focus just on this list.}, list_id: second_list.id, done: true)

Item.create(text: %{Click the "Add a to-do" link right below me to add your own to-do.}, list_id: second_list.id, done: true)
